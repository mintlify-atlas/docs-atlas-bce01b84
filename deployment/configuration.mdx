---
title: "Configure Applio Settings and Preferences"
sidebarTitle: "Configuration"
description: "Customize Applio's language, precision, theme, author tag, and Discord presence via the Settings tab or by editing the config.json file directly."
---
...
Configures default audio devices and settings for the **Realtime** voice conversion tab. The full set of keys:
