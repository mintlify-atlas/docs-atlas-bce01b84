...
**Gradio Web UI (`app.py`)** — The primary interface for most users. It exposes every Applio capability through a tabbed browser-based application that runs locally on `http://127.0.0.1:6969`. Tabs include Inference, Train, TTS, Download, Extra, Voice Blender, Plugins, Realtime, and Settings.
